#ifndef PROJECT1_MATH_FUNCTIONS_H
#define PROJECT1_MATH_FUNCTIONS_H

#endif //PROJECT1_MATH_FUNCTIONS_H
...
double runSquareRot(double x);
double runReverse(double x);
double runDivisonWithOne(double x);
